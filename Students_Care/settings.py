"""
Django settings for Students_Care project.
...
SECRET_KEY = 'django-insecure-(#9%7%e9kzgkw4-yg9x@k1%y04zne&nkzwienl@(5@h$7kiit7'
...
WSGI_APPLICATION = 'Students_Care.wsgi.application'
